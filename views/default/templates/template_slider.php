...
<div id="contenedor-slider" class="contenedor-slider">
	<div id="slider" class="slider">
		...
		<section class="slider__section slider_servicios"> 
			...
			<h2 class="titulo3"><span class="span_titulo3">Y A MEJOR PRECIO</span></h2>
		</section>
		<section class="slider__section slider_blog"> <img
			src="./views/default/img/salon_sofa_2.jpg" class="slider__img">
			<div class="saber_mas">
